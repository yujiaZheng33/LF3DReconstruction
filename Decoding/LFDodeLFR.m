...
clear all;
clc;
HeadPathID='D:\Works\light field\code\LF3DReconstruction\Decoding\';
...
% lytro: Axxxxxxxxxx
% illum: Bxxxxxxxxxx
WhiteImagesPath=[HeadPathID,'Sample_test\Cameras\B5145201300\']; 
LFUtilProcessWhiteImages( WhiteImagesPath);     

%% Step3: Decode your.lfp/.lfr files
tic
fprintf('=====================Step3: Decode LFP===================\n\n');
cd([HeadPathID,'Sample_test']);  % go to Sample_test directory

lfpname='IMG_1558';     % test file name
...
% end
version='B01';
InputFname=[HeadPathID,'Sample_test\Images\',version,'\',lfpname,'.LFR'];   
...
% save(['Results_saving\',lfpname,'\',lfpname,'RawLFColorCorrectedImage.mat'],'LFColorCorrectedImage');

%% show your light field image.
ViewLightField(LFColorCorrectedImage);
LF=permute(LFColorCorrectedImage(4:12,4:12,:,:,1:3),[3,4,5,1,2]);
save(['Results_saving\',lfpname,'\',lfpname,'LF.mat'],'LF');% very important
toc
%--------------------------------------------------------------------------------------------------------------------
